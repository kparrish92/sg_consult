...
The analysis is broken into sections. The first concerns the most important 5 questions that should be directly affected by the lesson. 


## Most important 5 questions:

1. How much do you like the idea of being/becoming bilingual? `becoming_bilingual`
...
```{r, 'pct1', echo=FALSE, fig.cap="The percentage of each rating by test type"}
pct_df_preq %>% 
